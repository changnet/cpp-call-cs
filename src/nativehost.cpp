...
namespace
{
    int run_component_example(const string_t& root_path)
    {
        ...
        const char_t *dotnet_type = STR("Loader.ModuleLoader, Loader");
        ...
        component_entry_point_fn call = nullptr;
        ...
        const char *moduleName = "DotNetLib.dll";
        ...
        load((void *)&args, sizeof(ModuleArgs));
        call((void*)&cargs, sizeof(ModuleArgs));
        unload((void*)&args, sizeof(ModuleArgs));
